...
const Pagination = () => {
    ...
    const { currentPage,productsPerPage,productsCount } = products
    ...
    return (
        <div className={styles.pagination}>
            <button 
                className={styles.pagination__prevButton} 
                onClick={() => onPrevPage(currentPage - 1)}>
                    ...
                    <span className={styles.pagination__prevButtonText}>Предыдущая</span>    
            </button>
            ...
            <button 
                ...
                onClick={() => onNextPage(currentPage + 1)}>
                    <span className={styles.pagination__nextButtonText}>Следущая</span>
